...
module.exports = {
    execute: async function(interaction, errEmb) {
        ...
        const date = new ActionRowBuilder().addComponents(new TextInputBuilder().setCustomId(`date`).setLabel(`Date et heure de la cérémonie`).setStyle(TextInputStyle.Short).setPlaceholder("JJ/MM/AAAA HHhmm").setRequired(true));
