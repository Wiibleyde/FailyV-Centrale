    ...
    execute: async function(interaction, errEmb) {
        ...
        if(userGuild != null) {
            ...
            try {
                ...
                await user.send({ embeds: [emb.generate('Suite à votre demande de debug', null, `La demande de debug de la foncitonnalitée **${interaction.message.embeds[0].title.split(': ')[1]}** à bien été revue et corrigée !\nLa mise à jour sera disponible ${fixTime}`, '#0DE600', `https://cdn.discordapp.com/attachments/1083724872045297734/1084447289914970182/yes.webp`, null, null, null, null, interaction.user.username, interaction.user.avatarURL(), true)] });
