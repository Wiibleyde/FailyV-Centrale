    ...
    execute: async function(interaction, errEmb) {
        ...
        if(userGuild != null) {
            ...
            try {
                ...
                await user.send({ embeds: [emb.generate('Suite à votre demande de debug', null, `La demande de debug de la foncitonnalitée **${interaction.message.embeds[0].title.split(': ')[1]}** à bien été revue mais n'a pas été jugée comme bug/n'a pas pu être reproduis\n\nMerci tout même de votre report, c'est grâce au personnes commme vous que l'on peut améliorer l'expérience utilisateur 💚`, '#FF0000', `https://cdn.discordapp.com/attachments/1083724872045297734/1084447275121647626/no.webp`, null, null, null, null, `Cordialement, ` + interaction.user.username, interaction.user.avatarURL(), true)] });
