    ...
    execute: async function(interaction, errEmb) {
        if(interaction.customId == 'serviceManage') {
            ...
            if(interaction.values[0] == 'serviceManageKickSingle') {
                ...
                await interaction.deferUpdate();
                try {
                    await reply.edit({ embeds: [emb.generate(null, null, `<a:loading:1137771560531398697> Retrait des personnes du service en cours...`, `Gold`, process.env.LSMS_LOGO_V2, null, `Gestion du service`, `https://cdn.discordapp.com/icons/${process.env.IRIS_PRIVATE_GUILD_ID}/${interaction.guild.icon}.webp`, null, null, null, false)], components: [], ephemeral: true });
                } catch (err) {
