...
module.exports = {
    execute: async function(interaction, errEmb) {
        if(interaction.customId == 'followRemoveSecoursForma') {
            reply = null;
            ...
            let options = new StringSelectMenuBuilder().setCustomId('followRemoveSecoursFormaSelect').setPlaceholder('Choisissez la/les personne(s) que vous souhaitez retirer de cette catégorie').setMinValues(1);
        ...
        } else if(interaction.customId == 'followRemoveSecoursFormaSelect') {
            try {
