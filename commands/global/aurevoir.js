...
module.exports = {
    ...
    async execute(interaction) {
        ...
        await service.kick(guild, botMember, false);
        ...
        await interaction.followUp({ embeds: [emb.generate(`Au revoir`, null, `Annonce de fin de service réussie, à bientôt je l'espère 💙`, `#000001`, process.env.LSMS_LOGO_V2, null, title, serverIcon, null, null, null, true)], ephemeral: true });
        await wait(5000);
