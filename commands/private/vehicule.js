        ...
        if(interaction.commandName == 'vehicule') {
            ...
            if(!security.isGen()) {
                ...
                if(!isVehNull) {
                    ...
                    try {
                        if(vehChanId[0] == null) {
                            return reply.edit({ embeds: [emb.generate(`Oups :(`, null, `Aucun salon de gestion des véhicules n'a été trouvé en base de donnée\nVeuillez faire un </report:1140480157367402507>, merci !`, "#FF0000", process.env.LSMS_LOGO_V2, null, `Gestion des véhicules`, `https://cdn.discordapp.com/icons/${process.env.IRIS_PRIVATE_GUILD_ID}/${interaction.guild.icon}.webp`, null, null, null, false)], components: [], ephemeral: true });
                        }
