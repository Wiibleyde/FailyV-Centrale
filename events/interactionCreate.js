...
module.exports = {
    ...
    async execute(interaction) {
        ...
        if(interaction.isChatInputCommand()) {
            ...
            logger.log(`${interaction.user.username}#${interaction.user.discriminator} (${interaction.user}) a utilisé(e) la commande "/${interaction.commandName}"`, interaction.client);
        ...
        if(interaction.isModalSubmit()) {
            ...
            logger.log(`${interaction.user.username}#${interaction.user.discriminator} (${interaction.user}) a utilisé(e) le Modal "${cID}"`, interaction.client);
        ...
        if(interaction.isButton()) {
            ...
            logger.log(`${interaction.user.username}#${interaction.user.discriminator} (${interaction.user}) a utilisé(e) le bouton "${cID}"`, interaction.client);
            //Pré-écriture d'un message d'erreur (pour éviter de l'écrire dans tout les fichers)
        ...
        if(interaction.isChannelSelectMenu() || interaction.isStringSelectMenu()) {
            ...
            logger.log(`${interaction.user.username}#${interaction.user.discriminator} (${interaction.user}) a utilisé(e) le menu de séléction "${cID}"`, interaction.client);
            //Pré-écriture d'un message d'erreur (pour éviter de l'écrire dans tout les fichers)
