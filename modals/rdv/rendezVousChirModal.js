...
module.exports = {
    ...
    execute: async function (interaction, errEmb) {
        ...
        const IRIS_SURGERY_CHANNEL_ID = await chanSql.getChannel('IRIS_SURGERY_CHANNEL_ID');
        const channelToSend = interaction.guild.channels.cache.get(IRIS_SURGERY_CHANNEL_ID[0].id);
