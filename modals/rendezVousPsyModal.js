...
module.exports = {
    ...
    execute: async function(interaction, errEmb) {
        ...
        //Create embed
        const rendezVousEmb = emb.generate(null, null, `**Nom et prénom:** ${interaction.components[0].components[0].value}\n**Numéro de téléphone:** ${phoneNumber}\n**Description:** ${interaction.components[2].components[0].value}\n**Contacté:** 0 fois\n**Pris par:**`, `#FF0000`, process.env.LSMS_LOGO_V2, null, `Rendez-vous psychologique`, `https://cdn.discordapp.com/attachments/1083724872045297734/1124914370217005127/LSMS.png`, null, pseudo, null, false);
