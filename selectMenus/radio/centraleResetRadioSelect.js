...
module.exports = {
    execute: async function(interaction, errEmb) {
        ...
        logger.log(`${interaction.member.nickname} - ${interaction.user.username}#${interaction.user.discriminator} (\\${interaction.user}) a utilisé(e) l'option "${interaction.values}" du menu de séléction "${interaction.customId}"`, interaction.client);
