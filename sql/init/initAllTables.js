...
module.exports = {
    initAllTables: () => {
        return new Promise(async (resolve, reject) => {
            ...
            await sendRequest("CREATE TABLE IF NOT EXISTS `agenda` (`name` VARCHAR(255) NOT NULL, `date` TIMESTAMP NOT NULL PRIMARY KEY, `by` VARCHAR(4) NOT NULL, `responsibles` TEXT NOT NULL, `allowed` TEXT NOT NULL, `confidentiality` BOOLEAN DEFAULT FALSE NOT NULL, `donor` BOOLEAN DEFAULT FALSE NOT NULL, `management` TEXT NOT NULL, `other` TEXT DEFAULT NULL, `writter` VARCHAR(255) NOT NULL, `contact` TEXT DEFAULT NULL, `agendaID` VARCHAR(255) NOT NULL, `mayorID` VARCHAR(255) NOT NULL, `LSPDID` VARCHAR(255) NOT NULL, `eventURL` VARCHAR(255) DEFAULT NULL, `state` TINYINT(2) DEFAULT 0 NOT NULL) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci"); //STATE -> 0=waiting; 1=event created; 2=ended
