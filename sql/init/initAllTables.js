...
module.exports = {
    initAllTables: () => {
        return new Promise(async (resolve, reject) => {
            ...
            await sendRequest("CREATE TABLE IF NOT EXISTS `doctor` (`id` INT(255) AUTO_INCREMENT NOT NULL, `discord_id` varchar(18) NOT NULL, `name` varchar(255) NOT NULL, `phone_number` varchar(8) NOT NULL, `rank_id` varchar(50) NOT NULL, `channel_id` varchar(20) NOT NULL, `arrival_date` DATE NOT NULL, `departure_date` DATE DEFAULT NULL NULL, CONSTRAINT `doctor_pk` PRIMARY KEY (id), CONSTRAINT `doctor_fk` FOREIGN KEY (rank_id) REFERENCES `doctor_rank`(id)) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci");
