...
module.exports = {
    initAllTables: () => {
        return new Promise(async (resolve, reject) => {
            ...
            await sendRequest("CREATE TABLE IF NOT EXISTS `agenda` (`id` INT(255) NOT NULL AUTO_INCREMENT PRIMARY KEY, `name` VARCHAR(255) NOT NULL, `date` TIMESTAMP NOT NULL, `by` VARCHAR(4) NOT NULL, `responsibles` TEXT NOT NULL, `allowed` TEXT NOT NULL, `confidentiality` BOOLEAN DEFAULT FALSE NOT NULL, `donor` BOOLEAN DEFAULT FALSE NOT NULL, `management` TEXT NOT NULL, `other` TEXT DEFAULT NULL, `writter` VARCHAR(255) NOT NULL, `contact` TEXT DEFAULT NULL, `agendaID` VARCHAR(255) NOT NULL, `mayorID` VARCHAR(255) NOT NULL, `LSPDID` VARCHAR(255) NOT NULL, `eventURL` VARCHAR(255) DEFAULT NULL, `state` TINYINT(2) DEFAULT 0 NOT NULL) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci"); //STATE -> 0=waiting; 1=event created; 2=ended
            ...
            await sendRequest("CREATE TABLE IF NOT EXISTS `follow_secours` (`id` INT(255) NOT NULL AUTO_INCREMENT PRIMARY KEY, `name` VARCHAR(255) NOT NULL, `phone` VARCHAR(8) NOT NULL, `company` VARCHAR(255) NOT NULL, `cat` BOOLEAN NOT NULL DEFAULT TRUE, `forma_rank` TINYINT(3) NOT NULL DEFAULT 0, `is_selected` BOOLEAN NOT NULL DEFAULT FALSE) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci");
