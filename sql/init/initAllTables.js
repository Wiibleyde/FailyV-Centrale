...
module.exports = {
    initAllTables: () => {
        return new Promise(async (resolve, reject) => {
            ...
            await sendRequest("CREATE TABLE IF NOT EXISTS `doctor_spe` (`id` varchar(50) NOT NULL, `name` varchar(50) NOT NULL, `role_id` varchar(20) NOT NULL, `emote` varchar(255) NOT NULL) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci");
            await sendRequest("CREATE TABLE IF NOT EXISTS `doctor` (`id` INT(255) AUTO_INCREMENT NOT NULL, `discord_id` text NOT NULL, `name` varchar(255) NOT NULL, `phone_number` varchar(8) NOT NULL, `rank_id` varchar(50) NOT NULL, `channel_id` varchar(20) NOT NULL, `holydays` BOOLEAN NOT NULL DEFAULT FALSE, `arrival_date` DATE NOT NULL, `departure_date` DATE DEFAULT NULL NULL, `removed` BOOLEAN NOT NULL DEFAULT FALSE, CONSTRAINT `doctor_pk` PRIMARY KEY (id), CONSTRAINT `doctor_fk` FOREIGN KEY (rank_id) REFERENCES `doctor_rank`(id)) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci");
            await sendRequest("ALTER TABLE `doctor` MODIFY COLUMN `departure_date` TIMESTAMP NULL DEFAULT NULL");
            ...
            await sendRequest("CREATE TABLE IF NOT EXISTS `category` (`name` VARCHAR(255) NOT NULL, `id` TEXT NOT NULL) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci");
            ...
            await sendRequest("CREATE TABLE IF NOT EXISTS `command_statistic` (`id` INT(255) NOT NULL AUTO_INCREMENT PRIMARY KEY, `command_name` VARCHAR(255) NOT NULL, `used` BIGINT UNSIGNED NOT NULL)");
            ...
            await sendRequest("CREATE TABLE IF NOT EXISTS `blackout` (`state` BOOLEAN NOT NULL DEFAULT FALSE PRIMARY KEY)");
            ...
            const getBlackoutMode = await sendRequest("SELECT * FROM `blackout`");
            if(getBlackoutMode[0] == null) {
                await sendRequest("INSERT INTO `blackout` SET `state`='0'");
            }
