...
module.exports = {
    initAllTables: () => {
        return new Promise(async (resolve, reject) => {
            ...
            await sendRequest("CREATE TABLE IF NOT EXISTS `doctor_card_category` (`id` varchar(50) NOT NULL, `name` varchar(100) NOT NULL, `position` INT NOT NULL, `color` varchar(7) DEFAULT '#000000' NOT NULL, CONSTRAINT doctor_card_category_pk PRIMARY KEY (id)) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci");
            ...
            await sendRequest("CREATE TABLE IF NOT EXISTS `lit_message` (`id` TEXT NOT NULL) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci");
